...
Most of public-key algorithm are clumsy to use in data transmission. Thus, key encapsulation mechanism could be used to use a public-key scheme to perform a 
