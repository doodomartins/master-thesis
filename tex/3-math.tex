...
Public-key cryptography was first introduced by Diffie and Hellman~\cite{diffie1976new} as a new concept to cryptography area. After that, Rivest, Shamir and Adleman proposes one of the most important public key criptosystem, that still are massive used on different cryptography applications~\cite{rivest1978method}. 
