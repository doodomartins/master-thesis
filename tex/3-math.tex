...
\begin{definition}
Let $f = \sum_{i=0}^{t}{g_{i}X^{i}}$ be a polynomial of degree $t$. Thus$f$ is a monoical polynomial if $f$ 
\end{definition}
We can note that a root of a polynomial it is equivalent to an factor of it. Because of X Y and Z
