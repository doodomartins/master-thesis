...
Finally, we recommend the usage of three root finding methods presented in this works. First one, the use of the new iterative BTA, in our experiments their present a small time variance, however, their made use of the Euclidean algorithm to compute the $gcd$ in . Second one was the usage 
