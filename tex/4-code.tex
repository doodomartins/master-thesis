...
\label{sub:mc-def}
In this Section we describe the three main algorithms of the McEliece cryptosystem based on irreducible binary Goppa code. This algorithms are related wi
