...
In our attack, we selected the precision parameter M as 500 since it was the one that showed the more precise results without taking a long time of computation.  In our tests, it took≈17 minutes for recovering one correct messagem.  \url{https://git.dags-project.org/gustavo/roots_finding/src/master/attack_bigquake}.