...
\begin{enumerate}
    ...
    \item Perform a timing side-channel against an cryptosystem: to ilustrate the 
    \item Literature review over root-finding methods: the main algorithms applied to compute the roots of a polynomial in code-based cryptosystems
