...
\begin{enumerate}
    ...
    \item Addition of different methods: Since the area of compute roots of a polynomial does not apply only on code-based cryptosystem, a search of methods which are not been used in code-based cryptography will be performed and we will list together the methods listed in the previus item the main methods
