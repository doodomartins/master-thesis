...
Our last countermeasure for finding roots of the error locator polynomial was the classical Cantor-Zassenhaus algorithm~\cite{cantor1981new}. This classical method is more general then the others algorithms, and it enables to be used in polynomials over binary finite fields. This adaptation introduces an trace computation and slight decreese their performance but it is one of the fastest method to finding roots over a finite field~\cite{}
