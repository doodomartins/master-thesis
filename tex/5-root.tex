...
Our last countermeasure for finding roots of the error locator polynomial was the classical Cantor-Zassenhaus algorithm~\cite{cantor1981new}. This classical method is more general then the others algorithms, and it enables to be used in polynomials over binary finite fields. 

The main difference beetwen Cantor-Zassenhaus method and the others methods presented in this chapter was the insertion of an randomness in the algorithm. 
