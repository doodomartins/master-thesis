...
To the best of our knowledge, any code-based cryptosystem made uses of an probabilistic algorithm as method for root finding. ALgorithm 
...
\begin{algorithm}[H]
 ...
 \KwResult{The set of roots of $p(x)$.}
    ...
    \Return{$Factors\;$}
 \caption{Probabilistic root finding -- $SCA(p(x))$.}
  \label{alg:new}
\end{algorithm}
\end{figure}
