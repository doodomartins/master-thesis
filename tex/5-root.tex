...
Our last proposal for finding roots of the error locator polynomial was the classical method proposed by Rabin~\cite{cantor1981new}. This classical method is an probabilistic algotithm and has running similar . Their are used to factor huge polynomials, with higher degree and over larger fields. Although the main focus of this works relies on polynomials with no more then 200 roots and fields of size at most $2^{16}$, we consider this algorithm because of its efficiency.
