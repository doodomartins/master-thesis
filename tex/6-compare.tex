...
This simple strategies was used to blind an timing side-channel attacker with a smaller time variance on the algorithm. This three algorithm still has some time variance, this was leaked by operations naturally non-constants, like the Euclidean algorithm, used to compute the GCD. 
