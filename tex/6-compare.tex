...
The main focus of our works relies on propose alternatives to compute roots of error locator polynomial without leak sensitive information against a timing side-channel attack. As previously presented, an naive implementation of the root finding process permits allows an attacker to recover the cihper text and compute an session key.
