...
\begin{lstlisting}[caption={Code snippet of BIGQUAKE error attribution },label={lst:label},language=C]
...
\begin{lstlisting}[caption={Code snippet of BIGQUAKE error attribution with the fix. },label={lst:label},language=C]
//Construct an error e from m
int error = {0};
m2errir(m, error);
